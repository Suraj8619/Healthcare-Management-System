...
👉 [https://suraj-frontend-kappa.vercel.app](https://prescripto.vercel.app/doctors/Dermatologist)
...
1. **Clone & Install:**
   ```bash
   git clone https://github.com/surajK8619/hms.git
